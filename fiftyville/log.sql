...
SELECT flights.destination_airport_id, name, phone_numebr, license_plate from people
JOIN passengers ON people.passort_number = passengers.passport_number
...
JOIN bank_accounts ON bank_accounts.person_id = people.id
JOIN atm_transactions ON atm_transactions.account_number = bank_accounts.acount_number
WHERE atm_transactions.year = 2021
AND atm_transactions.month = 7
AND atm_transactions.day = 28
